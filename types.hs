...
data ItemSet item = ItemSet { neck, waist, feet, bracers, torso, hands, head, legs, leftFinger, rightFinger, shoulders :: item, offhand :: Maybe item} deriving (Eq,Show,Ord,Functor,Foldable,Traversable)
